...
const InsightsView: React.FC<InsightsViewProps> = ({ insights, source = 'jobs', showHeader = true }) => {
    ...
    return (
        <div className="w-full animate-fade-in">
            {showHeader && <><h2 className="text-3xl font-bold text-white mb-2">Market Insights</h2>
            <p className="text-lg text-gray-400 mb-8">
                {source === 'jobs'
                    ? 'Aggregated trends from your current job requisitions.'
                    : 'Aggregated trends from your local candidate pool.'
                }
            </p></>}
                    ...
                    <div className="col-span-full text-center py-10 bg-slate-800/50 rounded-lg">
                        ...
                        {source === 'jobs' ? (
                            ...
                            <>
                                ...
                                <p className="text-sm text-gray-500">Import candidates to see analysis here.</p>
                            </>
                        )}
                    </div>
                )}
