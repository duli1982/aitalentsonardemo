    ...
    return (
        <div className={`${variant === 'compact' ? 'space-y-2' : 'space-y-4'} ${variant === 'compact' ? '' : 'p-4 border-b border-slate-700'}`}>
            ...
            <div className="relative">
                <input
                    type="text"
                    placeholder={'Boolean search: skill:React AND location:"Budapest"'}
            ...
            <p className="text-[10px] leading-4 text-slate-500">Supports AND, OR, NOT, parentheses and fields: skill, language, location, role, type, client, submission, consent, status.</p>
