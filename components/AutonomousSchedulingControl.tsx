            ...
            <div className="bg-slate-800 rounded-xl border border-slate-700 p-6">
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-white">Simulated Scheduling Prototype</h3>
                            <p className="text-xs font-semibold text-amber-300">Does not read live calendars or candidate replies</p>
