                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="bg-slate-900/50 rounded-lg p-4">
                        <div className="flex items-center gap-2 text-slate-400 mb-2">
                            ...
                            <span className="text-sm">Local candidate pool</span>
                        </div>
                        <p className="text-white font-semibold">
                            {typeof latest?.talentPool.localStoreCandidateCount === 'number'
                                ? latest.talentPool.localStoreCandidateCount.toLocaleString()
                                : '—'}
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-300">
                            ...
                            and posts alerts into Talent Pulse. It also tracks the local candidate pool size as a sanity check for imports.
                        </p>
                    </div>
                </div>
            </div>
