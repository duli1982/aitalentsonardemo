...
import RecruiterPipelineWorkspace from '../components/RecruiterPipelineWorkspace';
...
interface PipelinePageProps {
    ...
    handleUpdateCandidate: (candidateId: string, updatedData: Partial<Candidate>) => void;
}
...
const PipelinePage: React.FC<PipelinePageProps> = ({
    ...
    return (
        <div className="flex h-[calc(100vh-140px)] flex-col gap-4 md:flex-row">
            <div className="flex h-full w-full flex-col space-y-4 md:w-[310px] md:flex-none">
                    ...
                    <div className="p-4 flex-shrink-0">
                        <h2 className="text-xl font-semibold text-sky-400 mb-3 flex items-center justify-between">
                            <span className="flex items-center">
                                <Briefcase className="mr-2 h-5 w-5" />Requisitions
                            </span>
                            {jobs.length > 0 && (
                                <button
