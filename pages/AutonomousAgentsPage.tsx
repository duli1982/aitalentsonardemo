...
import DurableSourcingControl from '../components/DurableSourcingControl';
            ...
            <div className="container mx-auto p-6 max-w-6xl">
                <div className="mb-8">
                    ...
                    <p className="text-slate-400 ml-14">
                        Durable workers queue and process workspace tasks outside the browser. Sourcing remains recommend-only.
                    </p>
                </div>

                <DurableSourcingControl />
